...
PY
  then
    ...
    echo "Use the non-guided pointwise launcher instead: POINTS=\"0.100000:${mach} 0.125000:${mach} 0.150000:${mach}\" sbatch code/slurm/classical_convergence/jz_submit_supersonic_shooting_point_batch.slurm" >&2
    continue
  fi
