...
Dans [code/src/classical_solver/supersonic/shooting_supersonic.py](code/src/classical_solver/supersonic/shooting_supersonic.py), la variable principale est :
...
- [code/src/classical_solver/supersonic/shooting_supersonic.py](code/src/classical_solver/supersonic/shooting_supersonic.py)
...
- [code/src/classical_solver/supersonic/mstab17_supersonic_solver.py](code/src/classical_solver/supersonic/mstab17_supersonic_solver.py)
...
- [code/src/classical_solver/gep/dense_gep_notebook_style.py](code/src/classical_solver/gep/dense_gep_notebook_style.py)
...
- correction d'un décalage de calibration de l'axe Mach dans [code/scripts/evaluation/blumen_reference.py](code/scripts/evaluation/blumen_reference.py) ;
...
Ce point a été corrigé dans [code/scripts/evaluation/blumen_reference.py](code/scripts/evaluation/blumen_reference.py), mais les figures globales `c_i` et `c_r` doivent encore être relancées proprement après cette correction.
...
- [code/scripts/legacy/run_supersonic_gep_blumen_guided_sweep.py](code/scripts/legacy/run_supersonic_gep_blumen_guided_sweep.py)
- [code/scripts/audits/audit_diagnose_supersonic_candidate_modes_near_blumen.py](code/scripts/audits/audit_diagnose_supersonic_candidate_modes_near_blumen.py)
- [code/scripts/audits/audit_diagnose_supersonic_raw_spectrum_vs_blumen.py](code/scripts/audits/audit_diagnose_supersonic_raw_spectrum_vs_blumen.py)
- [code/scripts/evaluation/evaluate_compare_supersonic_gep_candidates_vs_shooting.py](code/scripts/evaluation/evaluate_compare_supersonic_gep_candidates_vs_shooting.py)
- [code/scripts/legacy/cluster_supersonic_mode_families.py](code/scripts/legacy/cluster_supersonic_mode_families.py)
- [code/scripts/legacy/track_supersonic_branch_beam_search.py](code/scripts/legacy/track_supersonic_branch_beam_search.py)
...
- [code/scripts/evaluation/track_supersonic_shooting_mach_continuation.py](code/scripts/evaluation/track_supersonic_shooting_mach_continuation.py)
- [code/scripts/evaluation/track_supersonic_shooting_multistart.py](code/scripts/evaluation/track_supersonic_shooting_multistart.py)
- [code/scripts/audits/audit_supersonic_blumen_eigenconditions.py](code/scripts/audits/audit_supersonic_blumen_eigenconditions.py)
- [code/scripts/audits/audit_supersonic_shooting_ci_map.py](code/scripts/audits/audit_supersonic_shooting_ci_map.py)
- [code/scripts/audits/audit_supersonic_shooting_mode_structure.py](code/scripts/audits/audit_supersonic_shooting_mode_structure.py)
- [code/scripts/audits/audit_supersonic_shooting_visual_validation_6969b4f1bf.py](code/scripts/audits/audit_supersonic_shooting_visual_validation_6969b4f1bf.py)
...
Dans [code/scripts/audits/audit_supersonic_shooting_visual_validation_6969b4f1bf.py](code/scripts/audits/audit_supersonic_shooting_visual_validation_6969b4f1bf.py), les champs sont reconstruits par :
...
![](assets/classic_supersonic/png/blumen_validation/blumen_eigencondition/Fig_supersonic_blumen_eigencondition_audit_a020_m120_130_mismatch_maps.png)
...
- solveur GEP :
  - [code/src/classical_solver/gep/dense_gep_notebook_style.py](code/src/classical_solver/gep/dense_gep_notebook_style.py)
- référence Blumen :
  - [code/scripts/evaluation/blumen_reference.py](code/scripts/evaluation/blumen_reference.py)
...
- reconstruction globale `c_i` :
  - [code/scripts/shooting/solve_reconstruct_supersonic_blumen_ci_visual.py](code/scripts/shooting/solve_reconstruct_supersonic_blumen_ci_visual.py)
- reconstruction globale `c_r` :
  - [code/scripts/shooting/solve_reconstruct_supersonic_blumen_cr_visual.py](code/scripts/shooting/solve_reconstruct_supersonic_blumen_cr_visual.py)
