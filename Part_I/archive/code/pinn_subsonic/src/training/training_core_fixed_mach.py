...
from pinn_subsonic.src.training.sampling_subsonic import (
    CIWindowCache,
...
from pinn_subsonic.src.models.model_kh_subsonic_pinn import KHSubsonicFixedMachPINN, load_fixed_mach_state_dict_compat
from pinn_subsonic.src.models.model_physics_residual import (
    base_velocity,
