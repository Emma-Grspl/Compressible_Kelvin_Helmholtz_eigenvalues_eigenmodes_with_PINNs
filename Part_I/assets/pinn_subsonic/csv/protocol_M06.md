...
- [jz_submit_kh_subsonic_pinn_M06_riccati_core1d.slurm](${PROJECT_ROOT}/code/src/launch/slurm/jz_submit_kh_subsonic_pinn_M06_riccati_core1d.slurm)
...
- [jz_submit_kh_subsonic_pinn_M06_riccati_mode_repair_edges.slurm](${PROJECT_ROOT}/code/src/launch/slurm/jz_submit_kh_subsonic_pinn_M06_riccati_mode_repair_edges.slurm)
...
- [jz_submit_kh_subsonic_pinn_M06_riccati_spectral_alpha_sweep.slurm](${PROJECT_ROOT}/code/src/launch/slurm/jz_submit_kh_subsonic_pinn_M06_riccati_spectral_alpha_sweep.slurm)
...
```bash
git pull
sbatch code/src/launch/slurm/jz_submit_kh_subsonic_pinn_M06_riccati_core1d.slurm
```
...
```bash
git pull
sbatch code/src/launch/slurm/jz_submit_kh_subsonic_pinn_M06_riccati_mode_repair_edges.slurm
```
