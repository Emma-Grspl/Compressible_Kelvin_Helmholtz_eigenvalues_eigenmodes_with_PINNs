...
def main() -> None:
    ...
    make_panel(
        ...
        title=r"Error in $\omega_i$ at Blumen points",
    ...
    make_panel(
        ...
        title="Point-to-solver-isoline distance",
        colorbar_label="Geometric distance in the (M, alpha) plane",
    )

    fig.suptitle("Subsonic shooting error map", fontsize=14)
