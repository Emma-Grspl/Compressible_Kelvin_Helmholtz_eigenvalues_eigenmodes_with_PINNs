#!/usr/bin/env python3
"""Compatibility entry point for `code/src/scripts/evaluation/evaluate_kh_subsonic_pinn_2d_ci_modes.py`.
...
SOURCE = REPO_ROOT / "code/src/scripts/evaluation/evaluate_kh_subsonic_pinn_2d_ci_modes.py"
