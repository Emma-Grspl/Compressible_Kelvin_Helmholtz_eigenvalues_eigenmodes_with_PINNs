#!/usr/bin/env python3
"""Compatibility entry point for `code/plots/scripts/pinn_subsonic/active_implementation/source_tree/scripts/plot_kh_subsonic_pinn_results_2d.py`.
...
SOURCE = REPO_ROOT / "code/plots/scripts/pinn_subsonic/active_implementation/source_tree/scripts/plot_kh_subsonic_pinn_results_2d.py"
