#!/usr/bin/env python3
"""Compatibility entry point for `code/plots/scripts/pinn_subsonic/active_implementation/source_tree/scripts/assets_v2/plot_mode_pdfs.py`.
...
SOURCE = REPO_ROOT / "code/plots/scripts/pinn_subsonic/active_implementation/source_tree/scripts/assets_v2/plot_mode_pdfs.py"
