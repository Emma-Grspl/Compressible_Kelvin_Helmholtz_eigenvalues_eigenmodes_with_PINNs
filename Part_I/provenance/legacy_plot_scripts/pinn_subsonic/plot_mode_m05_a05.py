#!/usr/bin/env python3
"""Compatibility entry point for `code/plots/scripts/pinn_subsonic/plot_mode_m05_a05.py`.
...
SOURCE = REPO_ROOT / "code/plots/scripts/pinn_subsonic/plot_mode_m05_a05.py"
