#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/assets_v2/pinn_article_tools.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/assets_v2/pinn_article_tools.py"
