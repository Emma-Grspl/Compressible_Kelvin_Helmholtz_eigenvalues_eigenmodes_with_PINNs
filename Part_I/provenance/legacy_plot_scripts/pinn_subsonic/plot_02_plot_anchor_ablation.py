#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/paper/subsonic_results/02_plot_anchor_ablation.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/paper/subsonic_results/02_plot_anchor_ablation.py"
