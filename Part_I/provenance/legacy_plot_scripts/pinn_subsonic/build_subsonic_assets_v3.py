#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/dev/build_subsonic_assets_v3.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/dev/build_subsonic_assets_v3.py"
