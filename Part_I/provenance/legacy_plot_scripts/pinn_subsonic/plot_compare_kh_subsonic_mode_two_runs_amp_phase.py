#!/usr/bin/env python3
"""Compatibility entry point for `code/src/scripts/evaluation/evaluate_kh_subsonic_mode_two_runs_amp_phase.py`.
...
SOURCE = REPO_ROOT / "code/src/scripts/evaluation/evaluate_kh_subsonic_mode_two_runs_amp_phase.py"
