#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/assets_v2/finalize_fig01_and_a5.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/assets_v2/finalize_fig01_and_a5.py"
