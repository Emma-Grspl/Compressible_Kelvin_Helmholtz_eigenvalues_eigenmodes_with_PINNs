#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/assets_v2/build_blumen_exact_point_comparison.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/assets_v2/build_blumen_exact_point_comparison.py"
