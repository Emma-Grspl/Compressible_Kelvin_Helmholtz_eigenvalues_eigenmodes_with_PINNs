#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/dev/build_joint_subsonic_final_assets.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/dev/build_joint_subsonic_final_assets.py"
