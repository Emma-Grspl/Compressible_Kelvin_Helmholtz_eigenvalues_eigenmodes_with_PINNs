#!/usr/bin/env python3
"""Compatibility entry point for `code/src/scripts/training/atlas/direct_pinn/train_kh_subsonic_pinn_2d.py`.
...
SOURCE = REPO_ROOT / "code/src/scripts/training/atlas/direct_pinn/train_kh_subsonic_pinn_2d.py"
