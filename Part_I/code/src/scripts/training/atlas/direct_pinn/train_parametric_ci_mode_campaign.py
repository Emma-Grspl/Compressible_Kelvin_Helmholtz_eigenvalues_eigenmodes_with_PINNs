#!/usr/bin/env python3
"""Compatibility entry point for `provenance/historical_material/code/scripts/run_kh_subsonic_pinn_2d_ci_mode_campaign.py`.
...
SOURCE = REPO_ROOT / "provenance/historical_material/code/scripts/run_kh_subsonic_pinn_2d_ci_mode_campaign.py"
