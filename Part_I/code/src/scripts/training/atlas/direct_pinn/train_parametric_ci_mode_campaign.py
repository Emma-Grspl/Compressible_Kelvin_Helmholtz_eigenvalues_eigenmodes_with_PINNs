#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/run_kh_subsonic_pinn_2d_ci_mode_campaign.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/run_kh_subsonic_pinn_2d_ci_mode_campaign.py"
