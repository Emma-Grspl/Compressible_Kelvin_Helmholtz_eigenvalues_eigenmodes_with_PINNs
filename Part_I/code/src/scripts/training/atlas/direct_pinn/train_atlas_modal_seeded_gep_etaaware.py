#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/dev/train_subsonic_seedGEP_pq2d_continuous_M_alpha_etaaware.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/dev/train_subsonic_seedGEP_pq2d_continuous_M_alpha_etaaware.py"
