#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/dev/train_subsonic_seedGEP_pQscaled2d_continuous_M_alpha.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/dev/train_subsonic_seedGEP_pQscaled2d_continuous_M_alpha.py"
