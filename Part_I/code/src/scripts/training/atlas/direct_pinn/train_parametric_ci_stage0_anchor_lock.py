#!/usr/bin/env python3
"""Compatibility entry point for `code/src/scripts/training/fixed_mach/physics_only/train_kh_subsonic_ci_stage0_anchor_lock.py`.
...
SOURCE = REPO_ROOT / "code/src/scripts/training/fixed_mach/physics_only/train_kh_subsonic_ci_stage0_anchor_lock.py"
