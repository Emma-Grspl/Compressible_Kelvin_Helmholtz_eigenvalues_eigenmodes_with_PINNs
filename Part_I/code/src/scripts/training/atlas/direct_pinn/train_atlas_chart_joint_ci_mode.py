#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/dev/train_subsonic_joint_spectral_modal_chart.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/dev/train_subsonic_joint_spectral_modal_chart.py"
