#!/usr/bin/env python3
"""Compatibility entry point for `provenance/historical_material/code/scripts/run_kh_subsonic_hybrid_alpha_sweep.py`.
...
SOURCE = REPO_ROOT / "provenance/historical_material/code/scripts/run_kh_subsonic_hybrid_alpha_sweep.py"
