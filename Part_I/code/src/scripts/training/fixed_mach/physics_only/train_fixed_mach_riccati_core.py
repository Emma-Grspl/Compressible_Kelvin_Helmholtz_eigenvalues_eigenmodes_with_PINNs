#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/run_kh_subsonic_riccati_core1d.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/run_kh_subsonic_riccati_core1d.py"
