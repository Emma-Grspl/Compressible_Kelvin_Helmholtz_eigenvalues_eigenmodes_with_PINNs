#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/run_kh_subsonic_ci_supervision_vs_physics.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/run_kh_subsonic_ci_supervision_vs_physics.py"
