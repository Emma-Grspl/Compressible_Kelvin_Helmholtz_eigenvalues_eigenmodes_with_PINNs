...
from src.scripts.gep.selection.solve_dense_gep_notebook_style import NotebookStyleDenseGEPSolver  # noqa: E402
from src.scripts.classical.solve_robust_subsonic_shooting import RobustSubsonicShootingSolver  # noqa: E402
...
def save_ci_curve_and_heatmaps(
    ...
    ax_err_h.set_yticks([])
    ax_err_h.set_title(r"Absolute error heatmap, PINN hybride (4 points)")
