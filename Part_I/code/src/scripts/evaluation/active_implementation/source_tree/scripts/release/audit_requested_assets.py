...
def main():
    ...
    groups = [
        ...
        ('B5','c_i','Validation hors grille',[f'{sci}/figures/SuppFig_random_offgrid_validation.pdf',f'{off}/offgrid_validation_results_384_release.csv',f'{off}/offgrid_validation_release_summary.csv',f'{off}/offgrid_validation_release_checks.csv']),
        ...
        ('D4','Audits GEP','Corrections de branche de référence',[f'{off}/offgrid_reference_branch_corrections.csv',f'{off}/offgrid_0246_branch_resolution.csv']),
