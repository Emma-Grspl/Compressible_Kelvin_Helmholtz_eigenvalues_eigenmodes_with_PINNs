#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/paper/subsonic_results/01_inspect_publication_data.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/paper/subsonic_results/01_inspect_publication_data.py"
