#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/assets_v2/canonicalize_mode_profiles.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/assets_v2/canonicalize_mode_profiles.py"
