#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/assets_v2/build_exact4_article_modes.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/assets_v2/build_exact4_article_modes.py"
