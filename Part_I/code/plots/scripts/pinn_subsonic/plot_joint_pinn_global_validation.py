#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/dev/joint_pinn_global_validation.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/dev/joint_pinn_global_validation.py"
