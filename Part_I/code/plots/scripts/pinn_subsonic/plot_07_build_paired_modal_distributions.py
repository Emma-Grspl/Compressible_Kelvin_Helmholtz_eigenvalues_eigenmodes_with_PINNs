#!/usr/bin/env python3
"""Compatibility entry point for `code/src/scripts/utils/build_paired_modal_distributions.py`.
...
SOURCE = REPO_ROOT / "code/src/scripts/utils/build_paired_modal_distributions.py"
