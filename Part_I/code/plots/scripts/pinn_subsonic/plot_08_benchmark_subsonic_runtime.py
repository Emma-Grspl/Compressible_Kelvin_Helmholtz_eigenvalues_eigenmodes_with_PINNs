#!/usr/bin/env python3
"""Compatibility entry point for `code/src/scripts/utils/utils_benchmark_subsonic_runtime.py`.
...
SOURCE = REPO_ROOT / "code/src/scripts/utils/utils_benchmark_subsonic_runtime.py"
