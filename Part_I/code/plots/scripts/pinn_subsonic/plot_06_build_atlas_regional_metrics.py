#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/paper/subsonic_results/06_build_atlas_regional_metrics.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/paper/subsonic_results/06_build_atlas_regional_metrics.py"
