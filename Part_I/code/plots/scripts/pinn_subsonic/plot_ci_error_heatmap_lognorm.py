#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/paper/subsonic_results/remake_ci_error_heatmap_lognorm.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/paper/subsonic_results/remake_ci_error_heatmap_lognorm.py"
