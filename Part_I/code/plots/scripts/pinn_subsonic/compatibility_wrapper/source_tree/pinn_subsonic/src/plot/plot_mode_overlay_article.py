#!/usr/bin/env python3
"""Compatibility entry point for `code/plots/scripts/pinn_subsonic/development_implementation/source_tree/scripts/dev/plot_mode_overlay_article.py`.
...
SOURCE = REPO_ROOT / "code/plots/scripts/pinn_subsonic/development_implementation/source_tree/scripts/dev/plot_mode_overlay_article.py"
