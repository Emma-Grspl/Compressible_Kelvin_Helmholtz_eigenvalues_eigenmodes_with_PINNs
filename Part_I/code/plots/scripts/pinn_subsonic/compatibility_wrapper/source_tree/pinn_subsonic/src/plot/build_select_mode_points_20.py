#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/assets_v2/select_mode_points_20.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/assets_v2/select_mode_points_20.py"
