#!/usr/bin/env python3
"""Compatibility entry point for `code/plots/scripts/pinn_subsonic/active_implementation/source_tree/scripts/plot_kh_subsonic_ci_error_heatmap.py`.
...
SOURCE = REPO_ROOT / "code/plots/scripts/pinn_subsonic/active_implementation/source_tree/scripts/plot_kh_subsonic_ci_error_heatmap.py"
