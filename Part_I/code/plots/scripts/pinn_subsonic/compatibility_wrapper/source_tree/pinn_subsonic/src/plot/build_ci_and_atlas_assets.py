#!/usr/bin/env python3
"""Compatibility entry point for `archive/code/scripts/assets_v2/build_ci_and_atlas_assets.py`.
...
SOURCE = REPO_ROOT / "archive/code/scripts/assets_v2/build_ci_and_atlas_assets.py"
